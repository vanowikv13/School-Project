    ...
    ?>
        ...
        <div class="text-right col-lg-12">
            ...
            if($result = @$con->query($sql)){
                ...
                $_SESSION['nadanie'] = '<span style="color:red">Brak linków w bazie do odkrycia</span><br>';
            ...
            echo"<form action='odLink.php' method='POST'>";
            echo"Link do odkrycia:<br> <input type='text' name='odk'/><br>";
