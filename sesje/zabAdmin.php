...
if ($con->connect_errno!=0)
{
    ...
    if($result = @$con->query($sql)) {
        if($result->num_rows>0) {
            ...
            echo"<form action='AdminZab.php' method='POST'>";
            echo"login na zabranie admina:<br> <input type='text' name='delete'/><br>";
            ...
            echo "</form>";
                ...
                $_SESSION['nadanie'] = '<span style="color:red">Brak userów do nadania!</span>';
